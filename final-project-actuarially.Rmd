...
claims.2017.data <- select(claimsdraft, policy_number, claim_date, claim_amount)
claims.2017.data <- filter(claims.2017.data, year(claim_date)==2017)
claims.2017.data <- filter(claims.2017.data, month(claim_date)==10)

ggplot(claims.2017.data) + geom_line(aes(x=,y=))
```
